...
void pvp(sf::RenderWindow& window, int* back) {
    char words_all[FIELD_SIZE * FIELD_SIZE][FIELD_SIZE * FIELD_SIZE];
                    ...
                    if (status == 0) {
                        ...
                        if (event.type == sf::Event::Closed) {
                            ...
                            if (corSel[0] + corSel[1] == -2) {//если энтер
                                ...
                                int len_man = 0, len_bot = 0, len_rand = 0;
                                for (int i = 0; i < man_cnt + bot_cnt + 1; i++) {
                                    for (int j = 0; j < word_len; j++) {
                                        if (wordsMan_current[j] == wordsMan[i][j]) {
                                            len_man++;
                                        }
                                        else if (wordsMan_current[j] == wordsBot[i][j]) {
                                            len_bot++;
                                        }
                                        else if (wordsMan_current[j] == rand_word[j]) {
                                            len_rand++;
                                        }
                                        if (len_man == word_len - 1 || len_bot == word_len - 1 || len_rand == word_len - 1) {
                                            a = 0;
                                        }
                                    }
                                }
                                    ...
                                    if (check == 0) {//если слова нет в словаре
                                        ...
                                        for (int i = 0; i < word_len; i++) {//довляем в массив слов сами буквы
                                            wordsMan[man_cnt][i] = wordsMan_current[i];
                                        }
...
int main() {
    ...
    Button buttons[4];
    const sf::String buttonLabels[] = { L"Играть PvE", L"Играть PvP", L"Сложность", L"Справка" };
    for (int i = 0; i < 4; ++i) {
